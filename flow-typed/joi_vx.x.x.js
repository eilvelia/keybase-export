...
declare module "joi" {
  declare export function alternatives(
    type1: npm$joi$Schema,
    type2: npm$joi$Schema,
    ...types: npm$joi$Schema[]
  ): npm$joi$Schema
  declare export function alternatives(types: npm$joi$Schema[]): npm$joi$Schema
  declare export function any(): npm$joi$Schema
  declare export function array(): npm$joi$ArraySchema
  declare export function assert(value: any, schema: npm$joi$Schema, message?: string | Error): void
  declare export function binary(): npm$joi$BinarySchema
  declare export function bool(): npm$joi$BooleanSchema
  declare export function boolean(): npm$joi$BooleanSchema
  declare export function compile(schema: Object | mixed[]): npm$joi$Schema
  declare export function date(): npm$joi$DateSchema
  declare export function func(): npm$joi$FunctionSchema
  declare export function number(): npm$joi$NumberSchema
  declare export function object(schema?: { [key: string]: npm$joi$Schema }): npm$joi$ObjectSchema
  declare export function ref(key: string, options?: ReferenceOptions): Reference
  declare export function string(): npm$joi$StringSchema
