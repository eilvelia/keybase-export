...
//   https://github.com/goodmind/FlowDefinitelyTyped/blob/7cac833/flow-types/types/elasticsearch_vx.x.x/flow_v0.25.x-/elasticsearch.js
declare module "elasticsearch" {
  declare export class HttpConnector {
      constructor(host: any, config: any): this;
      ...
      request(
        params: any,
        callback: (error: any, response: any, status: any, headers: any) => void
      ): void;
  }
  declare export class Client {
    ...
    count(
      params: CountParams,
      callback: (error: any, response: CountResponse) => void
    ): void;
    ...
    delete(
      ...
      callback: (error: any, response: DeleteDocumentResponse) => void
    ): void;
    ...
    explain(
      ...
      callback: (error: any, response: ExplainResponse) => void
    ): void;
    explain(params: ExplainParams): Promise<ExplainResponse>;
    fieldStats(
      params: FieldStatsParams,
      callback: (error: any, response: FieldStatsResponse) => void
    ): void;
    fieldStats(params: FieldStatsParams): Promise<FieldStatsResponse>;
    get<T>(
      params: GetParams,
      callback: (error: any, response: GetResponse<T>) => void
    ): void;
    ...
    mget<T>(
      params: MGetParams,
      callback: (error: any, response: MGetResponse<T>) => void
    ): void;
    ...
    ping(
      params: PingParams,
      callback: (err: any, response: any, status: any) => void
    ): void;
    ...
    reindex(
      ...
      callback: (error: any, response: ReindexResponse) => void
    ): void;
    ...
    scroll<T>(
      params: ScrollParams,
      callback: (error: any, response: SearchResponse<T>) => void
    ): void;
    ...
    searchShards(
      ...
      callback: (error: any, response: SearchShardsResponse) => void
    ): void;
  ...
  declare export type Refresh = boolean | "true" | "false" | "wait_for" | "";
  declare export type VersionType =
    | "internal"
    | "external"
    | "external_gte"
    | "force";
  ...
  declare export class Indices {
    ...
    rollover(
      ...
      callback: (error: any, response: IndicesRolloverResponse) => void
    ): void;
  ...
  declare class errors$BlockedByWindowsParentalControls
    mixins errors$_Abstract {}
